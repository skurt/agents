---
agent: agent
description: 'Describes the project configuration'
---
# Step: Title
Add a subtitle "Project Configuration" to the output file.

# Step: Check application startup configuration
Call #file:.github/prompts/pqa_check_feature.prompt.md with parameter Configure application startup.
If the hosting model is SaaS, also call #file:.github/prompts/pqa_check_feature.prompt.md with parameter SaaS application startup configuration and include those findings in this check.
...
Call #file:.github/prompts/pqa_check_feature.prompt.md with parameter middleware have the recommended order.
